<?php
    ...
    if (isset($_GET["nim"])) {
        $nim = $_GET["nim"];
        $result = mysqli_query($conn, "SELECT * FROM data_anggota WHERE NIM = $nim");
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Ubah Data Anggota
                    <small>HIMASTI</small>
                </h1>
                <ol class="breadcrumb">
            ...
            <div class="col-md-9">
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <hr>
                        <form action="ubahAnggota_keSQL.php?nim=<?php echo $nim ?>" method="POST">
                            ...
                            <div class="control-group form-group">
                                <div class="controls">
                                    ...
                                    <div class="radio">
                                        <label><input type="radio" name="gender" value="L" checked="checked">Laki-laki</label>
                                    </div>
                                    <div class="radio">
                            ...
                            <div class="control-group form-group">
                                <div class="controls">
                                    <label>Alamat:</label>
                                    <textarea rows="5" cols="100" class="form-control" name="alamat" maxlength="999" style="resize:none"><?php echo $alamat ?></textarea>
                                </div>
                            </div>
                            <div id="success"></div>
