<?php
   require_once("dbconf.php");
    ...
    if(!empty($_REQUEST['cariNIM'])){

        $NIMCari = mysql_real_escape_string($_REQUEST['cariNIM']);    
    }
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="jumbotron">
                    <h2 class="text-success"> Mulai pencarianmu dengan menggunakan area navigasi di sebelah kanan. </h2>
                    <hr>
                    <br>
                    <p> <h4 class="text-info"> <b> Search by NIM </b> </h4> akan membawamu ke halaman detil anggota berdasarkan NIM yang dimasukkan </p> 
                    <br>
                    <p> <h4 class="text-info"> <b> Kategori Angkatan </b> </h4> akan menampilkan daftar anggota Himpunan berdasarkan angkatan yang dipilih </p>
                </div>
